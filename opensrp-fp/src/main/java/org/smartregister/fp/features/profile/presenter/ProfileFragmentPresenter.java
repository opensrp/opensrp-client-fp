...
import org.smartregister.fp.features.profile.interactor.ProfileFragmentInteractor;
...
public class ProfileFragmentPresenter implements ProfileFragmentContract.Presenter {
    ...
    public Facts getImmediatePreviousContact(Map<String, String> clientDetails, String baseEntityId, String contactNo) {
        ...
        try {
            facts = FPLibrary.getInstance().getPreviousContactRepository().getPreviousContactFacts(baseEntityId, contactNo, true);
