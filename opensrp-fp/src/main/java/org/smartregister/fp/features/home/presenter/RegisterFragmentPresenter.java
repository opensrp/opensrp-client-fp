...
import org.smartregister.fp.features.home.model.RegisterFragmentModel;
...
public class RegisterFragmentPresenter implements RegisterFragmentContract.Presenter, AdvancedSearchContract.InteractorCallBack {
    ...
    public void initializeQueries(String mainCondition) {
        String tableName = FPLibrary.getInstance().getRegisterQueryProvider().getDemographicTable();
