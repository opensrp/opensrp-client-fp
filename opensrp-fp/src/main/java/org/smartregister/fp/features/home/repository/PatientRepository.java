    ...
    public static Map<String, String> getWomanProfileDetails(String baseEntityId) {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                detailsMap.put(DBConstantsUtils.KeyUtils.ID_LOWER_CASE, cursor.getString(cursor.getColumnIndex(DBConstantsUtils.KeyUtils.BASE_ENTITY_ID)));
                //detailsMap.put(DBConstantsUtils.KeyUtils.PHONE_NUMBER, cursor.getString(cursor.getColumnIndex(DBConstantsUtils.KeyUtils.PHONE_NUMBER)));
                ...
                //detailsMap.put(DBConstantsUtils.KeyUtils.ALT_PHONE_NUMBER, cursor.getString(cursor.getColumnIndex(DBConstantsUtils.KeyUtils.ALT_PHONE_NUMBER)));
                //detailsMap.put(DBConstantsUtils.KeyUtils.REMINDERS, cursor.getString(cursor.getColumnIndex(DBConstantsUtils.KeyUtils.REMINDERS)));
                //detailsMap.put(DBConstantsUtils.KeyUtils.HOME_ADDRESS, cursor.getString(cursor.getColumnIndex(DBConstantsUtils.KeyUtils.HOME_ADDRESS)));
