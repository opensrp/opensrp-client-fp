...
public class FPFormUtilsTest extends BaseUnitTest {
    ...
    public void testGetKeyWhenObjectIsEmpty() throws Exception {
        String itemKey = FPFormUtils.getObjectKey(new JSONObject());
        Assert.assertNull(itemKey);
    }

    @Test(expected = NullPointerException.class)
    public void testGetKeyWhenObjectIsNull() throws Exception {
        String itemKey = FPFormUtils.getObjectKey(null);
        Assert.assertNull(itemKey);
    }

    @Test
    public void testCleanValue() {
        String result = FPFormUtils.cleanValue("[one, two, three]");
    ...
    public void testValueConverter() {
        ...
        String expected = FPFormUtils.keyToValueConverter(entry);
    ...
    public void testValueConverterWithNullInput() {
        String actual = "";
        String expected = FPFormUtils.keyToValueConverter(null);
        assertEquals(expected, actual);
    }
    ...
    public void testRemoveKeyPrefix() {
        ...
        String result = FPFormUtils.removeKeyPrefix("step1_hiv_positive", "step1");
    ...
    public void testGetListValues() {
        ...
        String result = FPFormUtils.getListValuesAsString(list);
        assertEquals(result, actual);
    }
    ...
    public void testGetListValuesWithNullInput() {
        String actual = "";
        String result = FPFormUtils.getListValuesAsString(null);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromAncRadioButtons() throws JSONException {
        ...
        String result = FPFormUtils.obtainValue("ultrasound", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromDatePicker() throws JSONException {
        ...
        String result = FPFormUtils.obtainValue("blood_type_test_date", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromNativeRadioButton() throws JSONException {
        String actual = "ab";
        String result = FPFormUtils.obtainValue("blood_type", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromCheckbox() throws JSONException {
        ...
        String result = FPFormUtils.obtainValue("urine_test_notdone", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromNumberSelector() throws JSONException {
        String actual = "1";
        String result = FPFormUtils.obtainValue("no_of_fetuses", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testObtainValueFromHiddenValues() throws JSONException {
        ...
        String result = FPFormUtils.obtainValue("ultrasound_gest_age", accordionValuesJson);
        assertEquals(result, actual);
    }
    ...
    public void testFilterCheckboxValuesWhenFilterOptionsValuesAreDefineAsArray() throws Exception {
        ...
        FPFormUtils.processCheckboxFilteredItems(mainObject);
