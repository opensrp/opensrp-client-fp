...
public class ProfileActivityTest extends BaseActivityUnitTest {
    ...
    @Test
    public void testGenderViewIsInitialized() {

        TextView ageView = Whitebox.getInternalState(profileActivity, "genderView");
        Assert.assertNotNull(ageView);
    }

    @Test
    public void testClientIdViewIsInitialized() {

        TextView gestationAgeView = Whitebox.getInternalState(profileActivity, "clientIdView");
        Assert.assertNotNull(gestationAgeView);
    }

    @Test
    public void testAgeViewViewIsInitialized() {

        TextView gestationAgeView = Whitebox.getInternalState(profileActivity, "ageView");
        Assert.assertNotNull(gestationAgeView);
    }

    @Test
    public void testBtnStartFPVisitViewIsInitialized() {

        TextView ancIdView = Whitebox.getInternalState(profileActivity, "btnStartFPVisit");
    ...
    @Test
    public void testSetGenderShouldSetGenderViewWithCorrectContent() {

        ProfileActivity spyActivity = Mockito.spy(profileActivity);

        Whitebox.setInternalState(spyActivity, "genderView", textView);

        spyActivity.setProfileGender(TEST_STRING);

        Mockito.verify(textView).setText(StringUtils.capitalize(TEST_STRING));
    }

    @Test
    public void testSetClientIdShouldSetClientIdViewWithCorrectContent() {

        ProfileActivity spyActivity = Mockito.spy(profileActivity);

        Whitebox.setInternalState(spyActivity, "clientIdView", textView);
    ...
    @Test
    public void testSetAgeShouldSetAgeViewWithCorrectContent() {
    ...
    public void testSetProfileImageInvokesImageRenderHelperMethodsWithCorrectParameters() {
        ...
        Mockito.verify(imageRenderHelper).refreshProfileImage(DUMMY_BASE_ENTITY_ID, imageView, R.drawable.user_avatar);
