...
import org.smartregister.fp.application.FPTestApplication;
import org.smartregister.fp.common.util.FPJsonFormUtils;
import org.smartregister.fp.shadows.MyShadowActivity;
...
@Config(application = FPTestApplication.class, shadows = {MyShadowActivity.class}, sdk = Build.VERSION_CODES.P)
public abstract class BaseUnitTest {
    ...
    protected static final int DEFAULT_PROFILE_IMAGE_RESOURCE_ID = R.drawable.user_avatar;
    ...
    protected JSONObject getMainJsonObject(String filePath) throws Exception {
        ...
        return FPJsonFormUtils.readJsonFromAsset(context, filePath);
    }
}
